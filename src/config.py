...
API_TIMEOUT = 180
API_MAX_RETRIES = 5
EXTRACTOR_TIMEOUT_PER_CHUNK = 150  # 2.5 min por chunk (margem sobre os ~2min reais)
EXTRACTOR_TIMEOUT_MIN = 1200       # Mínimo 20 min
LOG_LEVEL = "INFO"
...
V42_ANALYSIS_MODEL = os.getenv("V42_ANALYSIS_MODEL", "anthropic/claude-sonnet-4.6")
